...
import Header from "../components/myStoryHeader";
const LoadMyStoryAbout = loadable(() => import("../components/myStoryAbout"))
...
const MyStory = () => {
	return (
		<>
		<Grid>
			<Layout title="Freelance Gatsby web developer in London - My story" />
