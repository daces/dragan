...
const Portfolio = () => {
	return (
		<Wrap>
			...
			<div>
				<LeftCol>
					<StaticImage src="../images/project2.jpg" alt="project 2" />
				</LeftCol>
				<RightCol>
					<h4>Web Design</h4>
					...
					<a href="/case-study-andy-hall-website" rel="noreferrer" target="_blank">
						Details<span>→</span>
					</a>
				</RightCol>
			...
			<div>
				<LeftCol>
					<StaticImage src="../images/project1.jpg" alt="project 1" />
				</LeftCol>
				<RightCol>
					<h4>Web Design</h4>
